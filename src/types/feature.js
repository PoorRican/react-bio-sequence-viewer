 ...
 * @see `editor.helpers.iterateHierarchy`
...
export function Feature(data) {
  ...
  // Non-standard data
  // TODO: these should separate from object. Implement `RenderFeature` to avoid deviating from specification.
  /**
   * Nested features are `Feature` objects whose `location` occurs within `this.location`.
